...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RuntimeVars) DeepCopyInto(out *RuntimeVars) {
	*out = *in
	if in.Args != nil {
		in, out := &in.Args, &out.Args
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RuntimeVars.
func (in *RuntimeVars) DeepCopy() *RuntimeVars {
	if in == nil {
		return nil
	}
	out := new(RuntimeVars)
