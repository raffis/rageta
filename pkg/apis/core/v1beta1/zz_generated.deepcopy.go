...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InputFrom) DeepCopyInto(out *InputFrom) {
	*out = *in
	if in.From != nil {
		in, out := &in.From, &out.From
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InputFrom.
func (in *InputFrom) DeepCopy() *InputFrom {
	if in == nil {
		return nil
	}
	out := new(InputFrom)
